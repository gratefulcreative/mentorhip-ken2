class IndividualController < ApplicationController
  ...
  def edit
    redirect_to edit_user_path(@individual.user)
  end
  ...
  def update
    ...
    respond_to do |format|
      if @individual.update_attributes(params[:individual])
        format.html { redirect_to @individual.user, notice: 'individual was successfully updated.' }
